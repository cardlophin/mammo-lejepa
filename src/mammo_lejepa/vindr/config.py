...
class PipelineConfig:
    ...
    # Concurrencia (research.md D-06)
    downloads: int = 6
    workers: int = 4
    queue_size: int = 12

    # Segmentación y normalización (recorte a resolución nativa, D-04)
    margin_px: int = 25
    ...
    # Máximo DICOM observado en el dataset (~35 MB)
    ...
    def disk_ceiling_bytes(self) -> int:
        """El disco intermedio máximo es una función conocida de los
