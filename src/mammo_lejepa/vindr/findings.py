...
def remap_findings(
    ...
    espacio del recorte, a resolución nativa (FR-016, D-04). Sólo las filas con
    coordenadas y cuya imagen tiene una `CajaMamaria` conocida (procesada con
    éxito) generan una fila; las filas sin caja son imágenes sin lesión
    anotada y se descartan aquí, contabilizadas por el llamador comparando
    alturas de entrada y salida. Un hallazgo cuya intersección con el recorte
    sea parcial o vacía se conserva marcado (`clipped`/`fully_contained`),
    nunca se elimina (FR-017)."""
